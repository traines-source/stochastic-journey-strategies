...
pub trait Query<'a> {
    ...
    fn relevant_connection_pairs(&mut self, weights_by_station_idx: &HashMap<usize, types::MFloat>, max_station_count: usize, start_time: types::Mtime, max_time: types::Mtime) -> HashMap<i32, i32>;
